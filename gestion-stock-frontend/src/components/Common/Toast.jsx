...
const Toast = ({ message, type = 'info', onClose, isVisible }) => {
  ...
  const getIcon = () => {
    const iconClass = 'w-6 h-6 flex-shrink-0 mr-3';
    ...
    >
      <div className="flex items-start">
        ...
        <button
          ...
          className="ml-4 flex-shrink-0 inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:text-gray-500 transition-colors"
        >
